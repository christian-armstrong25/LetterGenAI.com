...
// node_modules/.pnpm/langchain@0.0.92_mammoth@1.9.0_pdf-parse@1.1.1_puppeteer@19.11.1/node_modules/langchain/dist/chat_models/openai.js
var import_openai = __toESM(require_dist(), 1);

// node_modules/.pnpm/langchain@0.0.92_mammoth@1.9.0_pdf-parse@1.1.1_puppeteer@19.11.1/node_modules/langchain/dist/chat_models/base.js
...
// node_modules/.pnpm/langchain@0.0.92_mammoth@1.9.0_pdf-parse@1.1.1_puppeteer@19.11.1/node_modules/langchain/dist/util/prompt-layer.js
var promptLayerTrackRequest = async (callerFunc, functionName, prompt, kwargs, plTags, requestResponse, startTime, endTime, apiKey) => {
...
var ChatOpenAI = class extends BaseChatModel {
  ...
  constructor(fields, configuration) {
    ...
    const apiKey = (fields == null ? void 0 : fields.openAIApiKey) ?? getEnvironmentVariable("OPENAI_API_KEY");
    const azureApiKey = (fields == null ? void 0 : fields.azureOpenAIApiKey) ?? getEnvironmentVariable("AZURE_OPENAI_API_KEY");
    if (!azureApiKey && !apiKey) {
      throw new Error("(Azure) OpenAI API key not found");
    }
    const azureApiInstanceName = (fields == null ? void 0 : fields.azureOpenAIApiInstanceName) ?? getEnvironmentVariable("AZURE_OPENAI_API_INSTANCE_NAME");
    const azureApiDeploymentName = (fields == null ? void 0 : fields.azureOpenAIApiDeploymentName) ?? getEnvironmentVariable("AZURE_OPENAI_API_DEPLOYMENT_NAME");
    const azureApiVersion = (fields == null ? void 0 : fields.azureOpenAIApiVersion) ?? getEnvironmentVariable("AZURE_OPENAI_API_VERSION");
  ...
  async _generate(messages, options, runManager) {
    ...
    params.stop = (options == null ? void 0 : options.stop) ?? params.stop;
              ...
              if (part != null) {
                ...
                if (!choice.message) {
                  choice.message = {
                    ...
                    content: ((_d = part.delta) == null ? void 0 : _d.content) ?? ""
                  };
                }
                choice.message.content += ((_e = part.delta) == null ? void 0 : _e.content) ?? "";
                void (runManager == null ? void 0 : runManager.handleLLMNewToken(((_f = part.delta) == null ? void 0 : _f.content) ?? ""));
              }
            }
    ...
    for (const part of data.choices) {
      const role = ((_a = part.message) == null ? void 0 : _a.role) ?? void 0;
...
//# sourceMappingURL=chunk-IO5VUXXO.js.map
