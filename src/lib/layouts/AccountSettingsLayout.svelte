	...
	<div class="container">
		...
		<div class="white-box">
			...
			<div class="subtitle">
				...
				<h4>Free Plan</h4>
				<button class="upgrade-button" on:click={handleUpgradePlan}
					>Upgrade Plan</button
				>
			</div>
		</div>
		...
		<div class="white-box">
			...
			<input
				...
				value={firstName}
				readonly
				style="border: none; border-radius: 0; background-color: #F5F5F5; padding: 10px; width: 7rem;"
			/>
			<input
				type="text"
				value={lastName}
			...
			<input
				...
				value={user?.email}
				readonly
				style="border: none; border-radius: 0; background-color: #F5F5F5; padding: 10px; width: 14rem;"
			/>
		</div>
