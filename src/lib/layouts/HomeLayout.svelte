...
<div class="content">
	<div class="left">
		...
		<div class="benefits">
			<p>
				<b>1) Tailored to Your Unique Style:</b> Upload your writing samples for
				a cover letter that's authentically you.
			</p>
			<p>
				<b>2) Instant Results:</b> Say goodbye to endless hours spent crafting the
				perfect letter. Your time is valuable, let us help you save it.
			</p>
			<p>
				<b>3) Amplify Your Opportunities:</b> Boost your job applications with personalized,
